...
![](images/0f52345c2cd59064ff66fa59a85b767bc88ca0b7.jpg)

这道题是[26.remove-duplicates-from-sorted-array](26.remove-duplicates-from-sorted-array.html) 的进阶版本，唯一的不同是不再是全部元素唯一，而是全部元素不超过 2 次。实际上这种问题可以更抽象一步，即“删除排序数组中的重复项，使得相同数字最多出现 k 次” 。 那么这道题 k 就是 2， 26.remove-duplicates-from-sorted-array 的 k 就是 1。
...
![](images/fe59deca3c65dc0e362a78144f5b78696b26d52b.jpg)

![](images/b9f94ab5eab2080d2eb455ec16be8b1ac8eaf4d8.jpg)
...
<span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Solution</span>:</span>
    <span class="hljs-function"><span class="hljs-keyword">def</span> <span class="hljs-title">removeDuplicates</span><span class="hljs-params">(self, nums: List[int])</span> -> int:</span>
        <span class="hljs-title"># 写指针</span>
        i = <span class="hljs-params">0</span>
        K = <span class="hljs-params">2</span>
        <span class="hljs-keyword">for</span> num <span class="hljs-keyword">in</span> nums:
            <span class="hljs-keyword">if</span> i < K <span class="hljs-keyword">or</span> num != nums[i-K]:
                nums[i] = num
...
![](images/e2a9dba44a7d1d93f5923d22ae993dd0cabb0411.jpg)

- 1. 删除排序链表中的重复元素

![](images/de82aaf8091d2669866bd3c4d00b878956e3b56b.jpg)
